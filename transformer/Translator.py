...
class Translator(object):
    ...
    def __init__(self, opt):
        ...
        print("src_vocab_size: %d ; tgt_vocab_size: %d ;max_token_src_seq_len:%d ; max_token_tgt_seq_len: %d " %(model_opt.src_vocab_size,model_opt.tgt_vocab_size,model_opt.max_src_seq_len,model_opt.max_tgt_seq_len))
        model = Transformer(
            model_opt.src_vocab_size,
            model_opt.tgt_vocab_size,
            model_opt.max_src_seq_len,
            model_opt.max_tgt_seq_len,
